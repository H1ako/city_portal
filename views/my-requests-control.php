...
<body>
  ...
  <main class="main-content">
    ...
    <section class="main-content__news">
      <h2 class="news__bg-title">Управеление пользователями</h2>
      <div class="content">
        <div class="content__top">
          <h2 class="top__main-title">Управеление пользователями</h2>
        </div>
          ...
          <?php foreach ($users as $user) : ?>
            <li class="list__item">
              <div class="item__wrapper">
                ...
                <p class="wrapper__desc">Заявок: <?= $user->requests->count() ?></p>
                <div class="wrapper__actions">
                  <button delete-user data-id="<?= $user->id ?>" class="actions__delete">
                    Удалить
                  </button>  
                </div>
              </div>
    ...
    <section class="main-content__news news_requests">
